...
PROBLEMS = (
    # Problem 0,
    SnowmanState("START", 0, None, 8, 10, (2, 2),
                 {(2, 1): 0, (4, 3): 1, (1, 8): 2},
                 frozenset(((2, 3), (3, 0), (5, 1), (1, 3), (1, 2), (4, 5))),
                 (4, 1), ),
    # Problem 1,
    SnowmanState("START", 0, None, 6, 4, (2, 0),
                 {(1, 2): 0, (4, 1): 1, (3, 2): 2}, frozenset(((2, 3), (2, 2))),
                 (5, 1), ),
    # Problem 2,
    ...
    SnowmanState("START", 0, None, 5, 5,  # dimensions
                 ...
                 frozenset(((1, 0), (2, 0), (3, 0), (1, 4), (2, 4), (3, 4))),
                 # obstacles
                 (4, 4),  # destination
                 ),
    # Problem 4
    ...
    SnowmanState("Start", 0, None, 6, 7,  # dimensions
                 ...
                 frozenset(((1, 2), (1, 3), (1, 4), (1, 5), (1, 6), (2, 2),
                            (5, 1), (5, 0))),  # obstacles
                 (2, 3),  # destination
                 ),
    # Problem 7,
    SnowmanState("Start", 0, None, 6, 4,  # dimensions
                 ...
                 frozenset(((0, 0), (2, 0), (3, 0), (0, 3), (1, 3), (2, 3))),
                 # obstacles
                 (1, 0),  # destination
                 ),
    # Problem 8,
    SnowmanState("Start", 0, None, 6, 7,  # dimensions
                 ...
                 frozenset(((0, 0), (0, 1), (0, 2), (1, 2), (1, 3), (3, 2),
                            (3, 3), (4, 4),
                            (3, 0), (4, 0), (5, 0), (5, 1), (5, 2))),
                 # obstacles
                 (2, 2),  # destination
    ...
    SnowmanState("START", 0, None, 6, 4,  # dimensions
                 ...
                 frozenset((generate_coordinate_rect(4, 6, 0, 1)
                            + generate_coordinate_rect(0, 3, 3, 4))),
                 # obstacles
                 (3, 3),  # destination
                 ),
    # Problem 10
    ...
    SnowmanState("START", 0, None, 8, 6,  # dimensions
                 ...
                 frozenset((generate_coordinate_rect(0, 7, 0, 2) + [(0, 2),
                                                                    (6, 2),
                                                                    (7, 5)]
                            + generate_coordinate_rect(0, 5, 5, 6))),
                 # obstacles
                 (7, 0),  # destination
                 ),
    # Problem 14
    ...
    SnowmanState("Start", 0, None, 8, 7,  # dimensions
                 ...
                 frozenset(((0, 4), (1, 4), (2, 4), (3, 4), (5, 4), (1, 5),
                            (1, 6), (7, 6), (7, 5),
                            (7, 4), (7, 3), (7, 2), (2, 2), (4, 2), (5, 2),
                            (5, 1))),  # obstacles
                 (2, 3),  # destination
                 ),
    # Problem 16
    SnowmanState("START", 0, None, 9, 6,  # dimensions
                 ...
                 frozenset((generate_coordinate_rect(2, 7, 2,
                                                     3) + generate_coordinate_rect(
                     2, 3, 2, 6))),  # obstacles
                 (2, 0),  # destination
                 ),
    # Problem 17
    SnowmanState("START", 0, None, 10, 7,  # dimensions
                 ...
                 frozenset((generate_coordinate_rect(2, 8, 2,
                                                     3) + generate_coordinate_rect(
                     2, 3, 2, 7))),  # obstacles
                 (2, 0),  # destination
                 ),
